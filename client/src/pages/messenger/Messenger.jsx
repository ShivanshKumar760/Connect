...
export default function Messenger() {
  ...
  useEffect(() => {
    const getConversations = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_API}/conversations/` + user._id);
  ...
  useEffect(() => {
    const getMessages = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_API}/messages/` + currentChat?._id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_BACKEND_API}/messages/`, message);
